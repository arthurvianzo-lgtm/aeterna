...
export default function MargemSlider() {
  ...
  return (
    <section className="mb-6 rounded-2xl border border-line bg-panel p-5 sm:p-6">
      <div className="flex flex-wrap items-center gap-2">
        <ShieldCheck className="h-5 w-5 text-gold" />
        <h2 className="text-lg font-bold sm:text-xl">Trava de Margem — Aeterna</h2>
        <span className="ml-auto inline-flex items-center gap-1.5 rounded-full bg-gold/15 px-3 py-1 text-xs font-semibold text-gold">
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <div>
          <div className="flex items-center justify-between text-sm">
            <span className="font-medium text-muted">Sua margem de revenda</span>
            <span className="text-2xl font-black text-ink">{margem}%</span>
          </div>
          ...
          <input
            ...
            className="mt-3 h-2 w-full cursor-pointer appearance-none rounded-full bg-line accent-gold"
          />
          ...
          {noPiso && (
            <p className="mt-3 flex items-start gap-1.5 rounded-lg border border-danger/30 bg-danger/10 px-3 py-2 text-xs text-danger">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="rounded-xl border border-line bg-surface p-3">
            <p className="text-[11px] text-muted">Custo (com desconto)</p>
            <p className="mt-1 text-lg font-bold text-ink">{formatBRL(custoLiquido)}</p>
          </div>
          <div className="rounded-xl border border-line bg-surface p-3">
            <p className="text-[11px] text-muted">Preço de venda ao cliente</p>
          ...
          <div className="col-span-2 rounded-xl border border-line bg-surface p-3">
            <p className="text-[11px] text-muted">Sua comissão estimada (área interna)</p>
            <p className="mt-1 text-lg font-bold text-mint">
